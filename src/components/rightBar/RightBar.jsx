      ...
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText">
            <b>Itz Kathleen </b> and <b>3 other friends </b> have a birthday
            today .
          </span>
        </div>
      ...
      {user.username !== currentUser.username &&(
        ...
        <div className="rightbarFollowings">
          {friends.map((friend, i)=>(
            <Link to={"/profile/"+ friend.username} key={i} style={{textDecoration:"none"}}>
                 <div className="rightbarfollowing">
               <img
                 src={friend.profilePicture ? PF + friend.profilePicture : PF + "noAvatarpng.png"}
                 alt=""
