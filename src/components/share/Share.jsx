...
import "./share.css";
import { MdImage, MdLabel, MdRoom, MdEmojiEmotions, MdCancel } from "react-icons/md";
...
function Share({savePost}) {
  ...
  const submitHandler = async (e) => {
    ...
    if (!desc.current.value && !file) {
      alert("Please add some text or upload a file before submitting.");
      return;
    }
        ...
        <form className="shareBottom" onSubmit={submitHandler}>
          <div htmlFor="file" className="shareOptions">
            <label className="shareOption">
              <MdImage color="tomato" className="shareIcon" />
